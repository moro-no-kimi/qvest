...
This repository is a project workspace.
...
When creating new files for this project, place them in the `claudecodegstack/` directory to keep project artifacts organized.